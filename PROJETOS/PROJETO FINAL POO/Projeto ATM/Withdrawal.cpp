...
int Withdrawal::displayMenuOfAmounts() const{
    ...
    while (userChoice == 0){
        // exibe o menu
        screen.displayMassageLine("\nWithdrawal options:");
        screen.displayMassageLine("1 - $20");
        screen.displayMassageLine("2 - $40");
        screen.displayMassageLine("3 - $60");
        screen.displayMassageLine("4 - $100");
        screen.displayMassageLine("5 - $200");
        screen.displayMassageLine("6 - Cancel transaction");
