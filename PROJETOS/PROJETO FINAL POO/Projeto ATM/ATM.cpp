...
#include "Withdrawal.hpp" // definição da classe Withdrawal
#include "Deposit.hpp" // definição da classe Deposit
...
{
    screen.displayMassageLine("\nMain menu:");
    screen.displayMassageLine("1 - View my balance");
    screen.displayMassageLine("2 - Withdraw cash");
    screen.displayMassageLine("3 - Deposit funds");
    screen.displayMassageLine("4 - Exit\n");
